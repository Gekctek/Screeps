import {assignmentService} from "./components/assignments/assignment_service";
import {finder} from "../finder";
import  {notifier} from "../support/log";

export function assignIdle(room: Room) {
...
export function assignByRole(room: Room) {
	...
	for (var name in creeps) {
		...
		assignBasedOnRole(creep, creep.memory.role);
	}
}

export function assignFillSpawn(room: Room) {
	//TODO
...
export function assignDroppedItems(room: Room) {
...
export function assignBrokenStructures(room: Room) {
...
function assignBasedOnRole(creep: Creep, role: string) {
	switch (role) {
		case "HARVESTER":
